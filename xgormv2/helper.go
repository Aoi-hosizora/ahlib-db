...
// IsPostgreSQLUniqueViolationError is a variable that used to check if err is PostgreSQL's unique_violation error, notes that its error code is PostgreSQLUniqueViolationErrno.
//
// Example:
